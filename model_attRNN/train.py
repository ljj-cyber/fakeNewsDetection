...
from model_attRNN.attRNN import attRNN
...
def train(config, model, train_iter, dev_iter, test_iter, writer):
    ...
    for epoch in range(config.num_epochs):
        ...
        for i, (trains, labels) in enumerate(train_iter):
            ...
            msg1 = 'Iter: {0:>6},  Train Loss: {1:>5.4},  Train Acc: {2:>6.4%}'
            if total_batch % 20 == 0:
        ...
        msg2 = 'EPOCH: {0:>6},  Train Loss: {1:>5.4},  Train Acc: {2:>6.4%},  Val Loss: {3:>5.4},  Val Acc: {4:>6.4%},  Time: {5} {6}'
...
if __name__ == '__main__':
    ...
    train_data = My_Dataset('../data/wechat/train.csv', config, 1)
    dev_data = My_Dataset('../data/wechat/val.csv', config, 1)
    test_data = My_Dataset('../data/wechat/test.csv', config, 1)
