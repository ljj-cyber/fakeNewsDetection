...
class Config(object):
    def __init__(self):
        ...
        self.save_path = '../model/attRNN.ckpt'  # +'_'+self.resnet_name+'.ckpt'#保存模型的路径
        self.log_dir = '../log/'+self.bert_name.replace('../bert_model/','')+'_'+self.resnet_name  # tensorboard日志的0路径
